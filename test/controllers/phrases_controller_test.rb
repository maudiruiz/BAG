...
class PhrasesControllerTest < ActionController::TestCase
  ...
  test "should create phrase" do
    assert_difference('Phrase.count') do
      post :create, phrase: { description: @phrase.description, extra: @phrase.extra, title: @phrase.title }
    end
  ...
  test "should update phrase" do
    patch :update, id: @phrase, phrase: { description: @phrase.description, extra: @phrase.extra, title: @phrase.title }
    assert_redirected_to phrase_path(assigns(:phrase))
  end
